...
if __name__ == "__main__":
    ...
    path_to_log_file: str = os.path.join(PATH_TO_OUTPUT_DIR, 'features_info.log')
    ...
    labeled_patients = femr.labelers.load_labeled_patients(os.path.join(PATH_TO_OUTPUT_DIR, 'subsample_labeled_patients.csv'))
